# -*- coding: utf-8 -*-
"""
Created on Sat Oct 14 11:01:54 2023
...
for i in range(len(contours)):
    ...
    if hierarchy[0][i][3] == -1: # extorneal contour
...
"""
İlgili kütüphaneler içe aktarılır: OpenCV, Matplotlib ve Numpy.

Görüntü içe aktarılır ve görselleştirilir.

Görüntüye düşük geçiren filtre (medianBlur) uygulanır.

Gri tonlamaya dönüştürülür.

İkili eşikleme yapılır.

Nesne konturları bulunur ve dış konturlar yeşil renkte gösterilir.

Watershed algoritması kullanılarak nesneler arası sınırlar belirlenir:
    
    Görüntü tekrar içe aktarılır.
    Düşük geçiren filtre uygulanır.
    Gri tonlamaya dönüştürülür.
    İkili eşikleme yapılır.
    Açılma işlemi uygulanır.
    Nesneler arasındaki mesafe hesaplanır.
    Nesneler küçültülür.
    Arka plan için resim büyütülür.
    Nesne işaretleme ve bağlama yapılır.
    Watershed algoritması uygulanır.
    Sonuçta nesne konturları belirlenir ve dış konturlar kırmızı renkte gösterilir.
"""